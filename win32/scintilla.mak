...
!IFDEF DEBUG
DIR_O=..\winbuild\debug
!ELSE
DIR_O=..\winbuild\release
!ENDIF
DIR_BIN=..\bin
...
#ALL:	$(COMPONENT) $(LEXCOMPONENT) $(LEXCOMPONENT_LIB) $(LEXLIB) $(DIR_O)\ScintillaWinS.obj
ALL:	$(LEXCOMPONENT_LIB) $(LEXLIB) $(DIR_O)\ScintillaWinS.obj

clean:
	-del /q $(DIR_O)\*.obj $(DIR_O)\*.pdb $(COMPONENT) $(LEXCOMPONENT) $(LEXCOMPONENT_LIB) \
